...
<div class="container-fluid">
      <div class="row">
        <div class="col-md-12 text-center">
          <h1 class="standard_main_title">Remoção de tatuagem: quais os benefícios</h1>
        </div>
      </div>
    </div>
    ...
    <div class="container-fluid text-center">
      <div class="row">
        <div class="col-md-6 col-sm">
          <img src="./imagens/remoção.jpg" class="img-fluid standard__photo" alt="demonstração de remoção">
        </div>
        <div class="col-md-6 col-sm">
