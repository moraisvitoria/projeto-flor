    ...
    <!-- CONTEÚDO -->
      ...
      <div class="container-fluid">
          ...
          <div class="col-md-3 col-sm">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <p class="card-text">O preenchimento facial é um procedimento para embelezamento e reestruturação da pele envelhecida. O ácido hialurônico é uma das substâncias mais utilizadas e mais seguras
        ...
        .</p>
          ...
          <div class="col-md-3 col-sm">
            <div class="card">
              <img class="card-img-top" src="./imagens/intradermo-3.jpg" alt="Imagem de capa do card">
              <div class="card-body">
                <h5 class="card-title">Intradermonoterapia</h5>
                <p class="card-text"> é uma técnica pouco invasiva que consiste na utilização de injeções com medicamentos e vitaminas em locais do corpo a serem tratados. É o biomédico esteta que escolhe o que vai utilizar como medicamento, mas tudo vai depender do objetivo de cada tratamento. A técnica — criada em 1952 pelo médico francês Michel Pistor — foi desenvolvida originalmente para o tratamento de doenças vasculares e infecciosas, lesões esportivas e para a melhoria da circulação.</p>
                <a href="./facial.php" target="_blank" class="btn btn-primary">Clique e saiba mais</a>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-3 col-sm">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <p class="card-text">é um procedimento com foco na esfoliação da pele. Com isso, ele renova e ajuda a regenerar a pele das regiões tratadas. Geralmente, ele é feito no colo,
            ...
            escurecidas da pele, reduzir a oleosidade corporal e suavizar a aparência de cicatrizes.</p>
                <a href="./facial.php" target="_blank" class="btn btn-primary">Clique e saiba mais</a>
              </div>
            </div>
          </div>
