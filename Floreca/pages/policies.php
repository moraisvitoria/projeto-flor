...
?>
    ...
    <div class="container-fluid text-center conteudo">
      <div class="row">
        ...
        <img src="./imagens/policies.png" class="img__policies__privacy" alt="Políticas de Privacidade">
        </div>
        <div class="col-md-4 text__policies__privacy">
        <p><strong>A sua privacidade é importante para nós. É política do <em>Floreça</em> respeitar a sua privacidade em relação a qualquer informação sua que possamos coletar no site <em>Floreça</em>, e outros sites que possuímos e operamos.</strong></p>
    ...
    <h3>Política de Cookies <em>Floreça</em></h3>
    ...
    <p>O usuário se compromete a fazer uso adequado dos conteúdos e da informação que o <em>Floreça</em> oferece no site e com caráter enunciativo, mas não limitativo:</p>
    <ol type="A">
        ...
        <li>Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares) do <em>Floreça</em>, de seus fornecedores ou terceiros, para introduzir ou disseminar vírus informáticos ou quaisquer outros sistemas de hardware ou software que sejam capazes de causar danos anteriormente mencionados.</li>
    </ol>

    <h4>Mais informações</h4>
    <p>Esperemos que esteja esclarecido e, como mencionado anteriormente, se houver algo que você não tem certeza se precisa ou não, geralmente é mais seguro deixar os cookies ativados, caso interaja com um dos recursos que você usa em nosso site.</p>
    <p><em>Esta política é efetiva a partir de 17 de Fevereirp de 2023 às 18:57.</em></p>
...
<style>
    .tittle__policies__privacy{
        margin-top: 25px;
    }

    .img__policies__privacy{
        display: block;
        margin: auto;
        width: 100%;
        max-width: auto;
